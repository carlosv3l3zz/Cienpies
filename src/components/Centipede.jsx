...
const Centipede = () => {
  useEffect(() => {
    ...
    const handleKeyDown = (event) => Input.keys[event.keyCode] = true;
    const handleKeyUp = (event) => Input.keys[event.keyCode] = false;
    ...
    const animationInterval = setInterval(() => {
      ...
      const safeZoneWidth = window.innerWidth * 0.12;
      const safeZoneHeight = window.innerHeight * 0.1;
      ...
      const cornerX = window.innerWidth * 0.05;
      const cornerY = window.innerHeight * 0.1;
