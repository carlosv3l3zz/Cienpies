// ExpirationTimeSection.jsx
import { useEffect } from "react";
import { useClear } from "../ClearContext";

const ExpirationTimeSection = ({
  selectedExpiration,
  isExpirationSelected,
  ...
  return (
    <div className="w-[30.4%] h-[21vh] bg-[#1E1E1E] rounded-[10px] flex flex-col items-center justify-center m-2 py-7 px-6">
      <div className="w-full h-full flex justify-between">
        <h3 className="blanco">Expiration Time</h3>
        <input 
          className={`rounded-[50px] border-[1px] ${
            isExpirationSelected ? 'border-[#00E676]' : 'border-[#333]'
...
export default ExpirationTimeSection;